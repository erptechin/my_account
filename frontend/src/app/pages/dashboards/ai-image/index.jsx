...
const fields = ['campaign_name', 'objective', 'context_of_image', 'elements_my_image', 'image_style']
...
export default function ListData() {
  ...
  const [search, setSearch] = useState({ doctype, page: 1, page_length: 10, filters: JSON.stringify([[doctype, "brand", "=", user?.brandId]]), fields: null });
